...
########Section 1: Descriptive Statistics of the LIHTC Project (What are the data, broken out into categories such as phyical construction, geography, resident demographics, etc.?)#####################
...
##DESCRIPTIVE STATISTICS OF DEMOGRAPHICS HOUSING CHARACTERISTICS##
...
#Finding the top-5 most independent variables for predicting LIHTC allocation amounts: 
